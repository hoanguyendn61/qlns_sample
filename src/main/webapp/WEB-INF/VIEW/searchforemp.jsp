...
<body class="flex">
	<div class="mt-3 max-w-sl mr-auto ml-auto relative">
		<form action="<%=request.getContextPath()%>/searchforemp" method="post">
			<div class="flex justify-between">
				<div>
					<input type="radio" id="IDNV" name="searchField" value="IDNV">
					<label for="IDNV">IDNV</label><br>
				</div>
				<div>
					<input type="radio" id="Hoten" name="searchField" value="Hoten" checked="checked">
					<label for="Hoten">Họ và tên</label><br>
				</div>
				<div>
					<input type="radio" id="Diachi" name="searchField" value="Diachi">			
					<label for="Diachi">Địa chỉ</label>
				</div>
			</div>
			<div class="px-2 flex items-center border-1 bg-white shadow-md rounded-full">
				<input class="rounded-l-sm w-full py-2 px-6 text-gray-700 leading-tight focus:outline-none" name="search" type="text"placeholder="Search">
				<div class="p-2">
					<button
					type="submit"
